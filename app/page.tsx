...
<header className="wrap nav"><a className="brand" href="#">GO<span>♥</span>GO</a><nav className="navlinks"><a href="#mission">初衷</a><a href="#transparency">公开账本</a><a className="pill" href="#verify">验证信息</a></nav></header>
  <main>
    <section className="wrap hero">
      <div><div className="eyebrow">Guangzhou Together · 09.14</div><h1>GO<span className="heart">♥</span>GO</h1><p className="lead">献给在广州大学城 9 月 14 日事件中受到影响的人。一个由社区独立发起、以公开记录为承诺的纪念项目。</p><p><a className="pill" href="https://four.meme/en/token/0xa1d63e8d513d2ff5de3c0b574f80d3be303cffff" target="_blank" rel="noopener noreferrer">查看 GOGO 代币 ↗</a></p></div>
      <aside className="hero-note"><strong>买入 3% · 卖出 3%</strong><p>Four.meme 税费信息显示，税费 100% 分配至指定收款钱包。受赠渠道核实前，资金不会以“已捐赠”名义对外宣传。</p></aside>
      <CopyCA />
    </section>
    <section className="statement" id="mission"><div className="wrap statement-grid"><figure className="police-notice"><a href="/images/panyu-police-notice-20260914.jpg" target="_blank" rel="noopener noreferrer" aria-label="查看警情通报原图（新窗口）"><Image src="/images/panyu-police-notice-20260914.jpg" alt="警情通报：2026年9月14日，小谷围街发生持刀伤人事件，警方抓获嫌疑人，伤者经救治均无生命危险。落款为广州市公安局番禺分局。" width={690} height={1227} sizes="(max-width: 760px) 90vw, 360px" /></a><figcaption>图中署名：广州市公安局番禺分局<br />2026 年 9 月 14 日 · 项目方提供<br /><a href="/images/panyu-police-notice-20260914.jpg" target="_blank" rel="noopener noreferrer">点击查看原图 ↗</a></figcaption></figure><div><h2>记住受影响的人，<br />把每一笔承诺留在链上。</h2><p>据广州番禺公安 2026 年 9 月 14 日通报，小谷围街发生持刀伤人事件，嫌疑人已被抓获，伤者经救治均无生命危险，案件仍在进一步侦办。GOGO 不代表受害者、商场、学校、警方或政府机构。</p></div></div></section>
    <section className="wrap section"><div className="section-head"><h2>资金如何流转</h2><p>公开税费设置与收款地址，逐步补充余额、捐赠交易及收款证明，供独立核验。</p></div><div className="flow"><article className="step"><span className="num">01 · TRADE</span><div><h3>产生交易税</h3><p>Four.meme 显示买入税率 3%、卖出税率 3%；具体适用交易以合约机制为准。</p></div><span className="arrow">→</span></article><article className="step"><span className="num">02 · TREASURY</span><div><h3>进入公开金库</h3><p>税费 100% 分配至下方公开的收款钱包，可通过 BscScan 查看链上记录。</p></div><span className="arrow">→</span></article><article className="step"><span className="num">03 · ASSISTANCE</span><div><h3>核实后捐出</h3><p>公开受赠方、交易哈希及可披露的收款证明。</p></div><span className="arrow">✓</span></article></div></section>
    <section className="wrap section" id="transparency"><div className="section-head"><h2>实时进度与账本</h2><p>金库余额自动读取 BNB Smart Chain，每 30 秒刷新。</p></div><LiveTreasury /><div className="notice"><strong>透明度原则</strong><p>在出现经过核实的受赠渠道以前，金库中的金额只称为“待援助资金”，不称为“已捐款”，也不承诺可以直接转交给某位具体受害者。</p></div></section>
